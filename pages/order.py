...
st.markdown("**Total cost:** %s SP" % total_cost)
st.markdown("**Your points:** %s SP" % balance, help = "Special Attendance Points (SP) based on the provided HoYoLAB ID. If you think the value is not correct, please contact staff.")
