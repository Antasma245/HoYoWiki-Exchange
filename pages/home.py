...
st.title("Welcome to HSR-Exchange-α!")
...
:material/arrow_forward: You are currently on **HSR-Exchange-α**. To access HSR-Exchange-β, [click here](https://hsr-exchange-beta.streamlit.app/).
""")
